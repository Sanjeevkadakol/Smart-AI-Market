...
export const VoicePoweredOrb = ({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.1, 0.7, 0.4); // Emerald/Teal themed
    const vec3 baseColor2 = vec3(0.2, 0.4, 0.9); // Blue
    const vec3 baseColor3 = vec3(0.05, 0.05, 0.2); // Dark Navy
