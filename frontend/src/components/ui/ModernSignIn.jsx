...
export const ModernSignIn = ({ mode = 'login', onToggleMode, onSubmit }) => {
    const [visible, setVisible] = useState(false);
        ...
        <div className="flex min-h-screen bg-white overflow-hidden">
            ...
            <div className="hidden lg:flex flex-1 relative bg-zinc-50 items-center justify-center p-12 overflow-hidden">
                ...
                <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg">
                    <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-emerald-600 to-emerald-300 bg-clip-text text-center text-7xl font-bold leading-none text-transparent">
                        AI SANTHE
                    </span>
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-8 md:p-16 lg:p-24 bg-white shadow-2xl z-10">
                <div className="w-full max-w-sm space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-2 h-11 border border-zinc-200 rounded-xl text-sm font-medium hover:bg-zinc-50 transition border-dashed">
