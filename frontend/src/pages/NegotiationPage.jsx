...
const NegotiationPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-8">
            <header>
                <h1 className="text-4xl font-light text-zinc-900">Negotiation <span className="font-bold text-blue-600">Center</span></h1>
                <p className="text-zinc-500 mt-2 italic">Review incoming bids and close the best deals for your crops.</p>
            </header>

            {loading ? (
                <div className="py-20 text-center text-zinc-400 animate-pulse">Loading active negotiations...</div>
            ) : offers.length === 0 ? (
                <div className="py-20 text-center bg-zinc-50 rounded-[3rem] border border-dashed border-zinc-200">
                    ...
                    <p className="text-zinc-500 font-medium">No active offers yet. They'll appear here when buyers bid on your products.</p>
                </div>
            ) : (
                        ...
                        <div key={offer.offer_id} className="bg-white p-8 rounded-[2.5rem] border border-zinc-100 shadow-xl shadow-zinc-200/50 flex flex-col md:flex-row justify-between items-center gap-8 group hover:border-blue-100 transition-all">
                            <div className="flex items-center gap-6 flex-1">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 text-zinc-400 text-sm mt-1">
                                        ...
                                        <span>Buyer: {offer.buyer_name}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-12 flex-1 justify-center">
                                <div className="text-center">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-1">Base Price</p>
                                ...
                                <div className="text-center bg-blue-50 px-6 py-3 rounded-2xl border border-blue-100">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-blue-400 mb-1">Offered Price</p>
