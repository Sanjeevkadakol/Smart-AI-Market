            ...
            <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                <div className="p-8 space-y-6">
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-bold text-zinc-900">Make an <span className="text-blue-600">Offer</span></h2>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-zinc-500">Base Price: ₹{product.base_price}/kg</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 p-5 bg-zinc-50 rounded-3xl border border-zinc-100">
                        ...
                        <div className="space-y-2 text-sm text-zinc-600">
                            <div className="flex justify-between items-center">
                                <p>Current state:</p>
                                <span className="font-bold text-zinc-900 border-b border-zinc-200">Stable</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <p>Demand status:</p>
                                <span className="font-bold text-zinc-900 border-b border-zinc-200">Balanced</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest pl-1">Your Price (per kg)</label>
                        ...
                        >
                            {submitting ? 'Processing...' : status.type === 'success' ? 'Offer Submitted' : 'Submit Secure Offer'}
...
const ConsumerMarketplace = () => {
    ...
    if (loading) return <div className="p-12 text-center text-zinc-400 animate-pulse">Analyzing Market Dynamics...</div>;

    return (
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-4xl font-extralight text-zinc-900 tracking-tight">Direct <span className="font-semibold text-blue-600">Market</span></h1>
                    <p className="text-zinc-500 font-light">Fresh produce directly from regional farmers.</p>
                </div>
                        ...
                        <div className="p-8 flex-1 space-y-6">
                            <div>
                                ...
                                <div className="flex items-center gap-1.5 text-zinc-400 text-xs font-medium">
                                    ...
                                    <span>Farmer: <span className="text-zinc-600 font-bold">{p.farmer}</span></span>
                            ...
                            <div className="flex items-end justify-between bg-zinc-50 p-4 rounded-2xl border border-zinc-100/50">
                                <div>
                                    <span className="text-zinc-400 text-[10px] block font-bold uppercase tracking-tighter mb-1">Market Price</span>
                                ...
                                <div className="text-right">
                                    <span className="text-zinc-400 text-[10px] block font-bold uppercase tracking-tighter mb-1">Availability</span>
            ...
            {filteredProducts.length === 0 && (
                <div className="text-center py-24 space-y-4">
                    ...
                    <button onClick={() => setSearchTerm('')} className="text-blue-600 font-bold text-sm hover:underline">Clear all filters</button>
                </div>
            )}
